...
@media (max-width: 720px) {
  ...
  #library .home-rail .card:has(.quick-action) .next-episode strong {
    display: block;
    overflow: hidden;
    color: var(--color-accent-strong);
    text-overflow: ellipsis;
  ...
  .home-page #upcoming .section-heading .eyebrow,
  .home-page #top-ten .section-heading .eyebrow {
    display: none;
  }
  ...
  .home-page #upcoming .card:last-child {
    border-bottom: 0;
  }

  .home-page #upcoming .card:hover {
    transform: none;
  }

  .home-page #upcoming .poster,
  .home-page #upcoming .placeholder {
    align-self: center;
    width: 56px;
    height: 56px;
    margin-left: 10px;
  ...
  .home-page #upcoming .content {
    align-self: center;
    min-width: 0;
    padding: 10px 12px;
  }

  .home-page #upcoming .title {
    margin-bottom: 3px;
    font-size: .9rem;
  }

  .home-page #upcoming .meta {
    margin-bottom: 2px;
    color: var(--color-accent-strong);
    font-size: .75rem;
    font-weight: 750;
  ...
  .home-page #upcoming .content > p:not(.title) {
    margin: 0;
    overflow: hidden;
    color: var(--color-text-muted);
    font-size: .76rem;
  ...
  .home-page #top-ten .grid::-webkit-scrollbar {
    display: none;
  }

  .home-page #top-ten .top-ten-card {
    position: relative;
    display: block;
    flex: 0 0 118px;
    margin-left: 0;
  ...
  .home-page #top-ten .top-ten-rank {
    position: absolute;
    top: 6px;
    left: 6px;
    z-index: 2;
  ...
  .home-page #top-ten .content {
    padding: 7px 2px 0;
  }

  .home-page #top-ten .title {
    margin: 0;
    font-size: .74rem;
    line-height: 1.2;
  }
