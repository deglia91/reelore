...
from reelore.web_daily_use_polish import DAILY_USE_POLISH_CSS
from reelore.web_shell import NEXT_EP_SHELL_CSS
from reelore.web_shell_polish import SHELL_POLISH_CSS

_web_navigation_theme.NAVIGATION_CSS += (
    BRAND_POLISH_CSS + NEXT_EP_SHELL_CSS + SHELL_POLISH_CSS + DAILY_USE_POLISH_CSS
)
